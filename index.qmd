...
# metrics
metrics_week <- read_csv(file.path(path_models, "test_metrics_1week_0_v5_nested.csv"))
metrics_day <- read_csv(file.path(path_models, "test_metrics_1day_0_v5_nested.csv"))
metrics_hour <- read_csv(file.path(path_models, "test_metrics_1hour_0_v5_nested.csv"))
...
{{< embed notebooks/ema_figures.qmd#ema-fig-3 >}}
...
{{< embed notebooks/lag_figures.qmd#fig-methods >}}
...
{{< embed notebooks/lag_tables.qmd#tbl-demohtml >}} 
...
{{< embed notebooks/lag_figures.qmd#fig-2 >}}
...
{{< embed notebooks/lag_tables.qmd#tbl-contrast >}} 
